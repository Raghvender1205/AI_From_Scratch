...
class WeightStandardizedConv2d(nn.Conv2d):
    ...
    Weight Standardization synergistically working with Group Normalization

    This modified Conv2d is helpful for micro batch training and takes load of 
    GPU memory while training using Group Norms and Layer Norms 
    """
...
class LearnedSinusoidalPosEmb(nn.Module):
    """
    Learned Sinusoidal Postitional Embeddings
...
# Building Block Modules (Model Architecture Modules)
