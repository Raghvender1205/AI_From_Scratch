...
class ElucidatedDiffusion(nn.Module):
    ...
    def sample(self, batch_size=16, num_sample_steps=None, clamp=True):
        ...
        # Get schedule, which is returned as (sigma, gamma) and pair up with the next sigma and gamma
        ...
        # images are noise at beginnning
        init_sigma = sigmas[0]
        ...
        return unnormalize_zero_to_one(images)
    ...
    def forward(self, images):
        ...
        images = normalize_neg_one_to_one(images)
