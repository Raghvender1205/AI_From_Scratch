...
class ResBlock(Layer):
    def __init__(self, channels, out_channels):
        ...
        self.skip_connection = (
            PaddedConv2D(
                out_channels, 1) if channels != out_channels else lambda x: x
        )
...
class CrossAttention(Layer):
    ...
    def call(self, inputs):
        ...
        weights = softmax(
            score)  # (bs, num_heads, time, time)
        attention = td_dot(weights, v)
        attention = Permute((2, 1, 3))(
            attention
...
class SpatialTransformer(Layer):
    def __init__(self, channels, n_heads, d_head):
        ...
        self.transformer_blocks = [
            BasicTransformerBlock(channels, n_heads, d_head)]
