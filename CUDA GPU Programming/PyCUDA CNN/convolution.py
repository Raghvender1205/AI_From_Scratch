...
class Convolution:
    ...
    def par_padding(self, x, pad):
        ...
        output_cpu = np.ones(
            (new_height, new_width, channels), dtype=np.float32)
    ...
    def ser_conv(self, x, f, b, pad=0, stride=1):
        ...
        new_height = int(
            np.floor((height - filter_height + 2 * pad) / float(stride)) + 1)
        new_width = int(
            np.floor((width - filter_width + 2 * pad) / float(stride)) + 1)
    ...
    def par_max_pool(self, x, pool_size, stride):
        ...
        new_height = np.int32(
            np.floor((height - pool_size) / float(stride)) + 1)
    ...
    def par_conv_gl_coal_nopad_block1(self, x, f, b, pad=0, stride=1):
        ...
        output_cpu = np.zeros(
            (new_height, new_width, num_filters), dtype=np.float32)
        block_size, grid_size = assign_block_grid_block1(
            num_filters, new_height, new_width)
        #print('block_size:{}, grid_size:{}'.format(block_size, grid_size))
    ...
    def par_conv_sh_coal_nopad_noiter_block1(self, x, f, b, pad=0, stride=1):
        ...
        block_size, grid_size = assign_block_grid_block1(
            num_filters, new_height, new_width)
        #print('block_size:{}, grid_size:{}'.format(block_size, grid_size))
        conv_sh_coal_nopad_noiter_block1 = self.mod.get_function(
            "conv_sh_coal_nopad_noiter_block1")
    ...
    def par_conv_sh_coal_nopad_iter_block1(self, x, f, b, pad=0, stride=1):
        ...
        block_size, grid_size = assign_block_grid_block1(
            num_filters, new_height, new_width)
        #print('block_size:{}, grid_size:{}'.format(block_size, grid_size))
        conv_sh_coal_nopad_iter_block1 = self.mod.get_function(
            "conv_sh_coal_nopad_iter_block1")
    ...
    def par_conv_sh_coal_nopad_iter_block2(self, x, f, b, pad=0, stride=1):
        ...
        block_size, grid_size = assign_block_grid_block2(num_filters, filter_height, filter_width,
                                                         stride, new_height, new_width)
        #print('block_size:{}, grid_size:{}'.format(block_size, grid_size))
        conv_sh_coal_nopad_iter_block2 = self.mod.get_function(
            "conv_sh_coal_nopad_iter_block2")
